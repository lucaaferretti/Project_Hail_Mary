...
//funzione per allenare la rete neurale 
...
//funzione per stampare in output la matrice dei pesi (serve per controllo)
...
//funzione per richiamare la matrice una volta ricostruita l'immagine
...
//funzione energia (vedi github corso)
...
//funzione per salvare la matrice modificata nel file (usa fstream)
...
//funzione per prendere una matrice da un file 
